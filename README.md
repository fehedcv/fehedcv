...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=00C896&center=true&vCenter=true&width=500&lines=Hi+there%2C+I'm+Fahad+%F0%9F%91%8B;Full+Stack+Developer+in+the+making;React+%7C+Node+%7C+Python+%7C+MongoDB;Always+learning%2C+always+building)](https://git.io/typing-svg)
...
Hey! I'm **Fahad Mohammed Kabeer**, a self-driven developer from **Kozhikode, Kerala, India** who loves turning ideas into real, working products.

- 🔭 Currently building projects with the **MERN Stack**
- 🐍 Also comfortable with **Python** — FastAPI, Flask & Streamlit are my goto backends
- 🎨 I care about both design and functionality — **Figma → Code** is a workflow I enjoy
- ⚡ I tinker with **hardware too** — Arduino projects on the side
